...
class CamundaListener:
    ...
    def __init__(self, camunda_url):
        ...
        try:
            ...
            print(f"Error when creating cloud instance: {e}")
    ...
    def end_test(self, data, result):
        try:
            ...
            print(f"Error when end test happened: {e}")
    ...
    def close(self):
        try:
            ...
            print(f"Error when close happened: {e}")
    ...
    def _complete_task(self, robot_results_url):
        ...
        try:
            ...
            print(f"Could not send complete task to engine: {e}")
